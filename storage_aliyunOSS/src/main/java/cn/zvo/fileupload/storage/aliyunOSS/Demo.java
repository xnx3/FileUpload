...
public class Demo {
	...
	public static void main(String[] args) {
		...
		/**** 定义存储位置，存储到阿里云OSS中 ****/
		String key = "LTAI5tS4JqFNbWFQxxxxxxxxE";	//阿里云的 Access Key Id
		String secret = "kobusGhZLDYW0Vxvc621jiWeE7QCYl";	//阿里云的 Access Key Secret
		String endpoint = "oss-cn-shenzhen.aliyuncs.com";	//OSS服务的Endpoint。如：oss-cn-hongkong.aliyuncs.com
		String bucketname = "douyin-h5-shop-page";	//oss桶的名称
